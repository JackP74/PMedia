    ...
    public VolumeControl()
    {
        ...
        this.Loaded += delegate
        {
            try
            {
                ...
                thumb.MouseEnter += new(VolumeSlider_MouseEnter);
            }
            catch (Exception ex)
            {
            ...
            linearGradientBrush.GradientStops.Add(new(Color.FromArgb((byte)255, (byte)123, (byte)223, (byte)246), 0));
            linearGradientBrush.GradientStops.Add(new(Color.FromArgb((byte)255, (byte)120, (byte)187, (byte)239), 1));
